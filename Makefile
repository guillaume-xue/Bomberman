...
SERVER_SRCS = $(SERVER_DIR)/server.c $(COMMON_DIR)/func.c $(SERVER_DIR)/main_server.c
...
client: $(CLIENT_OBJS) $(COMMON_DIR)/func.o
...
clean:
	rm -f $(CLIENT_OBJS) $(SERVER_OBJS) $(COMMON_DIR)/func.o bin/client bin/server
